...
var nazarLocations = [
    ...
    {"id":"7", "x":"-66.046875","y":"151.03125"},       //Блюуотер марш
    {"id":"8", "x":"-84.4375","y":"82.03125"},          //Великие равнины
    {"id":"9", "x":"-90.53125","y":"135.65625"},        //Болджер Глейд
...
function addMarkerOnMap(value){
    ...
    switch (value.day) {
        case 'nazar':
            tempMarker.bindPopup(`<h1> ${languageData[value.text + '.name']} - 07.10 </h1><p>  </p>`);
            break;
        case 'fasttravel':
